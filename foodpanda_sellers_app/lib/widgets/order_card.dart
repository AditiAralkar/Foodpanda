...
import 'package:project/mainScreens/order_details_screen.dart';
    ...
    child: Row(
      children: [
        if (model.thumbnailUrl != null)
          ...
          Container(
              width: 120, color: Colors.grey), // Placeholder for missing image
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      model.title ?? "No title", // Provide a default value
                  ...
                  Text(
                    model.price?.toString() ?? "0", // Provide a default value
                    style: const TextStyle(
                      color: Colors.blue,
                      fontSize: 18.0,
                    ),
